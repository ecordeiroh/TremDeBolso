...
public class JardimAeroporto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horario__jd_aeroporto);
      ...
      getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        if (horas == 05 && minutos >= 30 && minutos <= 46 && dia >= 2 && dia <= 7 ) {
        ...
        if (horas == 7 && minutos >= 0 && minutos <= 30 && dia >= 2 && dia <= 7) {
        ...
        if (horas == 8 && minutos >= 35 && minutos <= 59 && dia >= 2 && dia <= 7 || horas == 9 && minutos >= 0 && minutos <= 14) {
        ...
        if (horas == 12 && minutos >= 25 && minutos <= 48 && dia >= 2 && dia <= 7 ) {
        ...
        if (horas == 14 && minutos >= 0 && minutos <= 32 && dia >= 2 && dia <= 6) {
        ...
        if (horas == 15 && minutos >= 35 && minutos <= 59 && dia >= 2 && dia <= 6 || horas == 16 && minutos >= 0 && minutos <= 16) {
        ...
        if (horas == 17 && minutos >= 35 && minutos <= 59 && dia >= 2 && dia <= 6 ) {
        ...
        if (dia == 4) {
            ...
            if (horas == 10 && minutos >= 35 && minutos <= 58) {
        ...
        if (dia == 1) {
            ...
            tv1.setText("09:06");
            if (horas == 8 && minutos >= 35 && minutos <= 59 || horas == 9 && minutos >= 0 && minutos <= 06) {
            ...
            tv2.setText("13:06");
            if (horas == 12 && minutos >= 35 && minutos <= 59 || horas == 13 && minutos >= 0 && minutos <= 06) {
        ...
        if (horas == 06 && minutos >= 35 && minutos <= 59 && dia >= 2 && dia <= 7 || horas == 7 && minutos >= 0 && minutos <= 11){
        ...
        if (horas == 8 && minutos >= 0 && minutos <= 55 && dia >= 2 && dia <= 7 ){
        ...
        if (dia >= 2 && dia <= 7 && horas == 12 && minutos >= 0 && minutos <= 29){
        ...
        if(dia == 7){
            ...
            tv10.setText("14:39");
            if(horas == 14 && minutos >= 0 && minutos <= 39){
        ...
        if (horas == 13 && minutos >= 35 && minutos <= 59 && dia >= 2 && dia <= 6 || horas == 14 && minutos >= 0 && minutos <= 13){
        ...
        if (horas == 15 && minutos >= 0 && minutos <= 57 && dia >= 2 && dia <= 6 ){
        ...
        if (horas == 17 && minutos >= 00 && minutos <= 41 && dia >= 2 && dia <= 6 ){
        ...
        if (horas == 18 && minutos >= 35 && minutos <= 59 && dia >= 2 && dia <= 6 || horas == 19 && minutos >= 0 && minutos <= 24){
        ...
        if(dia == 4) {
            ...
            if (horas == 10 && minutos >= 0 && minutos <= 39 ){
        ...
        if(dia == 1){
            ...
            tv7.setText("12:39");
            if(horas == 12 && minutos >= 0 && minutos <= 39){
            ...
            tv8.setText("15:39");
            if(horas == 15 && minutos >= 0 && minutos <= 39){
