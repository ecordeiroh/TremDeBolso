...
public class Alecrim2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horario__alecrim2);
       ...
       // cal.set(Calendar.DAY_OF_WEEK, 1);
        ...
        if (horas == 06 && minutos >= 0 && minutos <= 18 && dia >= 2 && dia <= 7) {
        ...
        if (horas == 9 && minutos >= 30 && minutos <= 59 && dia >= 2 && dia <= 7) {
        ...
        if (horas == 9 && minutos >= 15 && minutos <= 46 && dia >= 2 && dia <= 7) {
        ...
        if (horas == 13 && minutos >= 0 && minutos <= 20 && dia >= 2 && dia <= 7) {
        ...
        if (horas == 14 && minutos >= 30 && minutos <= 59 && dia >= 2 && dia <= 6) {
        ...
        if (horas == 16 && minutos >= 15 && minutos <= 48 && dia >= 2 && dia <= 6) {
        ...
        if (horas == 18 && minutos >= 0 && minutos <= 31 && dia >= 2 && dia <= 6) {
        ...
        if (dia == 4) {
            ...
            if (horas == 11 && minutos >= 0 && minutos <= 25) {
        ...
        if (dia == 1) {
            ...
            tv1.setText("09:38");
            if (horas == 9 && minutos >= 10 && minutos <= 45) {
            ...
            tv2.setText("13:38");
            if (horas == 13 && minutos >= 10 && minutos <= 45) {
        ...
        if (horas == 06 && minutos >= 0 && minutos <= 39 && dia >= 2 && dia <= 7 ){
        ...
        if (horas == 8 && minutos >= 0 && minutos <= 23 && dia >= 2 && dia <= 7 ){
        ...
        if (horas == 11 && minutos >= 30 && minutos <= 57 && dia >= 2 && dia <= 7 ){
        ...
        if(dia == 7){
            ...
            tv10.setText("14:07");
            if(horas == 13 && minutos >= 20 && minutos <= 59){
        ...
        if (horas == 13 && minutos >= 0 && minutos <= 41 && dia >= 2 && dia <= 6 ){
        ...
        if (horas == 15 && minutos >= 0 && minutos <= 25 && dia >= 2 && dia <= 6 ){
        ...
        if (horas == 17 && minutos >= 00 && minutos <= 9 && dia >= 2 && dia <= 6 ){
        ...
        if (horas == 18 && minutos >= 20 && minutos <= 52 && dia >= 2 && dia <= 6 ){
        ...
        if(dia == 4) {
            ...
            if (horas == 9 && minutos >= 30 && minutos <= 59 || horas == 10 && minutos >= 0 && minutos <= 7){
        ...
        if(dia == 1){
            ...
            tv7.setText("12:07");
            if(horas == 11 && minutos >= 30 && minutos <= 59 || horas == 12 && minutos >= 0 && minutos <= 7){
            ...
            tv8.setText("15:07");
            if(horas == 14 && minutos >= 30 && minutos <= 59 || horas == 15 && minutos >= 0 && minutos <= 7){
